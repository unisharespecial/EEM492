...
const int TEMPO = 100;		// Beats per minute (the original song is played at 104 BPM but that's
							// a little too fast to watch so it has been slowed down to 100 BPM)
