...
class _DropboxClient__doc__(object):
    """Represents a user accessing the application.

    You need a ``DropboxClient`` instance to construct a
    :class:`dropbox.datastore.DatastoreManager` instance.

    For full documentation of this class see
    https://www.dropbox.com/static/developers/dropbox-python-sdk-1.6-docs/index.html#dropbox.client.DropboxClient
    """

    def __init__(self, oauth2_access_token):
        """Construct a ``DropboxClient`` from an OAuth 2 access token.

        The access token is a string obtained using either
        :class:`DropboxOAuth2Flow` or
...
class DropboxClient(object):
    ...
    def get_file(self, from_path, rev=None):
        ...
        Returns:
            - A RESTResponse that is the result of the request. The RESTResponse
              can be treated as a file descriptor on the socket.
    ...
    def thumbnail(self, from_path, size='large', format='JPEG'):
        ...
        Unlike most other calls, thumbnail returns a raw RESTResponse with the connection open.
        You should call .read() and perform any processing you need, then call .close()
...
# Dummy class for docstrings, see doco.py.
class _DropboxOAuth2FlowNoRedirect__doc__(object):
    """OAuth 2 authorization helper. Use this for command-line apps.

    For full documentation of this class see
    https://www.dropbox.com/static/developers/dropbox-python-sdk-1.6-docs/index.html#dropbox.client.DropboxOAuth2FlowNoRedirect
    """
...
# Dummy class for docstrings, see doco.py.
class _DropboxOAuth2Flow__doc__(object):
    """OAuth 2 authorization helper.  Use this for web apps.

    OAuth 2 has a two-step authorization process.  The first step is
    having the user authorize your app.  The second involves getting
    an OAuth 2 access token from Dropbox.

    For full documentation of this class see
    https://www.dropbox.com/static/developers/dropbox-python-sdk-1.6-docs/index.html#dropbox.client.DropboxOAuth2Flow
    """
