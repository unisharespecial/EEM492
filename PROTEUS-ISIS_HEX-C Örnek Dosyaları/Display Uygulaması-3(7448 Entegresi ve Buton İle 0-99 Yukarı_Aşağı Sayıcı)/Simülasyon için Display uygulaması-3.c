...
void main ()
{
   ...
   {
       output_b(digit[birler]|(0b00100000)); // 1.display aktif, 2.display pasif yapýlýyor ve birler basamaðý bilgisi B portuna gönderiliyor
       delay_ms(5);                          // Gecikme veriliyor
       output_b(digit[onlar]|(0b00010000));  // 2.display aktif, 1.display pasif yapýlýyor ve onlar basamaðý bilgisi B portuna gönderiliyor
       delay_ms(5);                          // Gecikme veriliyor
